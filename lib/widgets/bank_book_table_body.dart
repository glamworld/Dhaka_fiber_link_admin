...
class BankBookTableBody extends StatefulWidget {
  String? headOfAccount,name,details,debit,credit,month,year;


  BankBookTableBody(
      {this.headOfAccount, this.name, this.details, this.debit, this.credit,this.month,this.year});

  @override
  _BankBookTableBodyState createState() => _BankBookTableBodyState();
}

class _BankBookTableBodyState extends State<BankBookTableBody> {
  @override
