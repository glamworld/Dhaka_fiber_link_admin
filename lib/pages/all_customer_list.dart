...
class _AllCustomerListState extends State<AllCustomerList> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_counter == 0) {
      setState(() {
        customerList=customerProvider.customerList;
        ...
        children: [
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    _tableHeaderBuilder(size, 'Installation Fee'),
          ...
          _isLoading
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context,index)=>CustomerListTableBody(
                  ...
                  installationFee: filteredCustomers[index].installationFee,
